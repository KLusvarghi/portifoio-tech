...
const ContainerToggleTheme = styled.div<{ $fixed: boolean }>`
  cursor: pointer;
...
export const ToggleThemeButton = ({ fixed }: { fixed: boolean }) => {
  ...
  if (theme.title == 'light') {
    return (
      <ContainerToggleTheme $fixed={fixed} onClick={() => handleToggleTheme()}>
        <svg
          width={size}
          height={size}
          viewBox="0 0 30 30"
